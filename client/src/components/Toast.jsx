...
const Toast = () => {
  ...
  return (
    <div className={`${toastInfo.visible ? "translate-y-20 opacity-100" : "-translate-y-20 opacity-0"} overflow-hidden fixed w-fit rounded-lg shadow-lg bg-white/95 h-12 left-[50%] -translate-x-1/2 transition-all duration-100 flex flex-col items-center border border-gray-200 z-10`}>        
