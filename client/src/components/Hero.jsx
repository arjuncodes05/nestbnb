...
const Hero = () => {
  ...
  return (
    <>
        <div className='w-full h-screen bg-[url("/src/assets/heroImage.png")] bg-center bg-cover flex flex-col pt-15 md:pt-0 justify-center items-start space-y-4 sm:space-y-6 text-white px-4 sm:px-8 md:px-10 lg:px-24 xl:px-32'>
