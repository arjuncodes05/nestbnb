...
const Hero = () => {
  return (
    <>
        <div className=' absolute top-0 w-full h-screen bg-[url("/src/assets/heroImage.png")] bg-center bg-cover flex flex-col pt-20 md:pt-0 justify-center items-start space-y-4 sm:space-y-6 text-white px-4 md:px-10 lg:px-24 xl:px-32'>
            ...
            <form className="bg-white text-black flex md:flex-row flex-col sm:flex-wrap lg:flex-nowrap lg:items-center p-4 rounded-lg gap-4 select-none sm:w-2/5 md:w-fit">
            ...
            <div className="flex justify-center items-center">
                <button className="bg-black text-white text-lg w-full h-12 px-4 rounded-md flex items-center justify-center gap-1 cursor-pointer active:scale-95">
