...
const ExclusiveOffers = () => {
  ...
  return (
    <div className="w-full flex bg-white flex-col items-center mt-10 h-screen py-5 md:py-12 text-black space-y-5 sm:space-y-8 px-4 sm:px-8 md:px-10 lg:px-24 xl:px-32">
